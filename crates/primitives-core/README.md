...
Everything a verifier does not need stays in `nectar-primitives`: chunk stores, encryption, envelopes, ECIES, the routing metrics, the thread-safety markers, and the wasm bindings.
