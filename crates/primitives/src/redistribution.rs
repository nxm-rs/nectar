...
use crate::{ChunkAddress, DefaultHasher, Proof, SwarmAddress};
...
/// [`EXTENDED_PO`](crate::EXTENDED_PO) (36 bits) and would collapse addresses
/// that share a 36-bit prefix into an equal-and-thus-unstably-ordered class,
/// breaking cross-peer determinism. The full-distance comparison yields a total
/// order that every node reproduces identically.
///
...
///
/// ```
/// use nectar_primitives::redistribution::canonical_neighbourhood;
...
///
/// ```
/// use nectar_primitives::redistribution::sample;
/// use alloy_primitives::B256;
///
...
mod tests {
    ...
    fn entitlement_build_and_verify_round_trip() {
        ...
        let mut buf = vec![0u8; crate::DEFAULT_BODY_SIZE];
