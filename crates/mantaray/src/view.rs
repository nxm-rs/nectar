...
mod tests {
    ...
    /// Carried from the mantaray-rs port as marshal-compatibility fixtures
    /// aligned to the Go bee reference implementation; v0.1 and v0.2 wire
    /// images with XOR obfuscation applied.
