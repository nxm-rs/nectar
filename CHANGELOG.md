...
- [contracts] Correct deployment addresses and guard against upstream drift ([#91](https://github.com/nxm-rs/nectar/issues/91))

### Miscellaneous Tasks

- Ignore agent and local worktree directories
